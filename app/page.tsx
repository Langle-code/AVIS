  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--cream)' }}>
      <header style={{
        ...
        borderBottom: '1px solid rgba(184,224,200,0.4)',
        background: 'var(--white)',
        position: 'sticky', top: 0, zIndex: 10,
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{
            width: 34, height: 34, background: 'var(--sage)', borderRadius: '50%',
            display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 17,
          }}>🌿</div>
          <span style={{ fontFamily: 'Fraunces, serif', fontSize: 21, fontWeight: 500, color: 'var(--bark)' }}>
            Avis
          </span>
        </div>
      ...
      <main style={{ maxWidth: 660, margin: '0 auto', padding: '28px 20px' }}>
        {showIngest && (
          <div className="fade-up" style={{ marginBottom: 24 }}>
            <IngestPanel onSuccess={() => { setShowIngest(false); fetchQuestions(subject) }} />
          </div>
        )}
        ...
        <div style={{ marginTop: 24 }}>
          {loading ? (
            ...
            <div className="card" style={{ textAlign: 'center', padding: '56px 28px' }}>
              ...
              <p style={{ color: 'var(--moss-light)', marginBottom: 24 }}>
                Add a YouTube link or PDF to get started.
              </p>
            ...
            <div className="fade-up" key={currentQ.id}>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 14, gap: 10 }}>
                <span style={{ fontSize: 12, color: 'var(--moss-light)', whiteSpace: 'nowrap' }}>
                  {currentIndex + 1} / {questions.length}
                </span>
                <div style={{ flex: 1, height: 4, background: 'rgba(184,224,200,0.3)', borderRadius: 2 }}>
                  <div style={{
                    height: '100%', background: 'var(--sage-deep)', borderRadius: 2,
